        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details mb-3">
              ...
              <h1>Who is Going?</h1>
              <p>
                Trip to {{ $items->travelPackage->title}} , {{ $items->travelPackage->location }}
              </p>
              <div class="attendee">
              ...
              <div class="member mt-3">
                <h2>Add Member</h2>
                <form class="form-inline"  method="POST" action="{{ route('checkout-create', $items->id) }}">
                  @csrf
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <table class="trip-informations">
                <tr>
                  ...
                  <td width="50%" class="text-right">{{ $items->details->count() }} person</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">${{$items->travelPackage->price}}/ person</td>
                </tr>
                <tr>
                  <th width="50%">Sub Total</th>
                  <td width="50%" class="text-right">${{$items->transaction_total}}</td>
                </tr>
                <tr>
            ...
            <div class="join-container">
              <a
                href="{{ route('checkout-success',$items->id) }}"
                class="btn btn-block btn-join-now mt-3 py-2"
                >I Have Made Payment</a
              >
            </div>
            <div class="text-center mt-3">
              <a href="{{ route('detail',$items->travelPackage->slug) }}" class="text-muted">Cancel Booking</a>
            </div>
          </div>
        </div>
      </div>
